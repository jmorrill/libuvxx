...
namespace uvxx { namespace streams
{
    ...
    public:
        ...
        typedef uvxx::streams::char_traits<_CharType> traits;
...
#pragma endregion
    ...
    public:
        ...
        uvxx::streams::basic_istream<_CharType> create_istream() const
        {
            if (!can_read()) throw std::runtime_error("stream buffer not set up for input of data");
            return uvxx::streams::basic_istream<_CharType>(*this);
        }
        ...
        uvxx::streams::basic_ostream<_CharType> create_ostream() const
        {
            if (!can_write()) throw std::runtime_error("stream buffer not set up for output of data");
            return uvxx::streams::basic_ostream<_CharType>(*this);
        }
