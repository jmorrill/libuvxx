...
namespace uvxx { namespace streams 
{
        ...
        public:
            ...
            static uvxx::streams::basic_istream<char_type> open_istream(_CollectionType data)
            {
                return uvxx::streams::basic_istream<char_type>(buffer_type(std::move(data), std::ios_base::in));
            }

            static uvxx::streams::basic_ostream<char_type> open_ostream()
            {
                return uvxx::streams::basic_ostream<char_type>(buffer_type(std::ios_base::out));
            }
        };
        ...
        public:
            ...
            template<typename _CollectionType>
            static uvxx::streams::istream open_istream(_CollectionType data)
            {
                return uvxx::streams::istream(streams::container_buffer<_CollectionType>(std::move(data), std::ios_base::in));
            }

            template<typename _CollectionType>
            static uvxx::streams::ostream open_ostream()
            {
                return uvxx::streams::ostream(streams::container_buffer<_CollectionType>());
            }
        };
