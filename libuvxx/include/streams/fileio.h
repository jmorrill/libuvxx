...
namespace uvxx { namespace streams
{
...
/// </remarks>
_ASYNCRTIMP bool __cdecl _open_fsb_str(_In_ uvxx::streams::details::_filestream_callback *callback, const utility::char_t *filename, std::ios_base::openmode mode, int prot);
...
/// </remarks>
_ASYNCRTIMP bool __cdecl _close_fsb_nolock(_In_ uvxx::streams::details::_file_info **info, _In_ uvxx::streams::details::_filestream_callback *callback);
_ASYNCRTIMP bool __cdecl _close_fsb(_In_ uvxx::streams::details::_file_info **info, _In_ uvxx::streams::details::_filestream_callback *callback);
...
_ASYNCRTIMP size_t __cdecl _putn_fsb(_In_ uvxx::streams::details::_file_info *info, _In_ uvxx::streams::details::_filestream_callback *callback, const void *ptr, size_t count, size_t char_size);
...
/// <param name="ptr">A pointer to a buffer where the data should be placed</param>
/// <returns>0 if the read request is still outstanding, -1 if the request failed, otherwise the size of the data read into the buffer</returns>
_ASYNCRTIMP size_t __cdecl _putc_fsb(_In_ uvxx::streams::details::_file_info *info, _In_ uvxx::streams::details::_filestream_callback *callback, int ch, size_t char_size);
...
/// <param name="count">The size (in characters) of the buffer</param>
/// <returns>0 if the read request is still outstanding, -1 if the request failed, otherwise the size of the data read into the buffer</returns>
_ASYNCRTIMP size_t __cdecl _getn_fsb(_In_ uvxx::streams::details::_file_info *info, _In_ uvxx::streams::details::_filestream_callback *callback, _Out_writes_ (count) void *ptr, _In_ size_t count, size_t char_size);
...
_ASYNCRTIMP bool __cdecl _sync_fsb(_In_ uvxx::streams::details::_file_info *info, _In_ uvxx::streams::details::_filestream_callback *callback);
...
_ASYNCRTIMP utility::size64_t __cdecl _get_size(_In_ uvxx::streams::details::_file_info *info, size_t char_size);
...
/// <returns><c>true</c> if the request was initiated</returns>
_ASYNCRTIMP size_t __cdecl _seekrdpos_fsb(_In_ uvxx::streams::details::_file_info *info, size_t pos, size_t char_size);
...
/// <param name="pos">The new position (offset from the start) in the file stream</param>
/// <returns><c>true</c> if the request was initiated</returns>
_ASYNCRTIMP size_t __cdecl _seekrdtoend_fsb(_In_ uvxx::streams::details::_file_info *info, int64_t offset, size_t char_size);
...
/// <param name="pos">The new position (offset from the start) in the file stream</param>
/// <returns><c>true</c> if the request was initiated</returns>
_ASYNCRTIMP size_t __cdecl _seekwrpos_fsb(_In_ uvxx::streams::details::_file_info *info, size_t pos, size_t char_size);
}
#endif