...
namespace details
{
    ...
    private:
        ...
        void _Invoke()
        {
            long tid = uvxx::pplx::details::platform::GetCurrentThreadId();
        ...
        void _DeregisterCallback(_In_ _CancellationTokenRegistration *_PRegistration)
        {
            ...
            if (synchronize)
            {
                ...
                switch(result)
                {
                    ...
                    {
                        long tid = result;
                        if (tid == uvxx::pplx::details::platform::GetCurrentThreadId())
                        {
                            //
                        ...
                        {
                            _PRegistration->_M_pSyncBlock->wait(uvxx::pplx::extensibility::event_t::timeout_infinite);
                        }
...
public:
    ...
    cancellation_token(cancellation_token&& _Src) : _M_Impl(std::move(_Src._M_Impl))
    {
    }
    ...
    /// </returns>
    template<typename _Function>
    uvxx::pplx::cancellation_token_registration register_callback(const _Function& _Func) const
    {
        if (_M_Impl == NULL)
        {
...
#pragma warning(suppress: 28197)
    ...
    {
        return (_M_Impl == NULL) ? uvxx::pplx::details::_CancellationTokenState::_None() : _M_Impl;
    }
...
private:
    ...
    cancellation_token(_ImplType _Impl) :
        _M_Impl(_Impl)
    {
        if (_M_Impl == uvxx::pplx::details::_CancellationTokenState::_None())
        {
            _M_Impl = NULL;
        }
...
public:
    ...
    typedef uvxx::pplx::details::_CancellationTokenState * _ImplType;
    ...
    { 
        _M_Impl = new uvxx::pplx::details::_CancellationTokenState;
    }
