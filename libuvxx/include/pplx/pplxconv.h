...
uvxx::task<_TaskType> pplx_task_to_concurrency_task(uvxx::pplx::task<_TaskType> _Task)
{
    return _Ppl_conv_helpers::_Convert_task<typename uvxx::pplx::task<_TaskType>, uvxx::task<_TaskType>, uvxx::task_completion_event<_TaskType>>(_Task);
}

template<typename _TaskType>
uvxx::pplx::task<_TaskType> concurrency_task_to_pplx_task(uvxx::task<_TaskType> _Task)
{
    return _Ppl_conv_helpers::_Convert_task<typename uvxx::task<_TaskType>, uvxx::pplx::task<_TaskType>, uvxx::pplx::task_completion_event<_TaskType>>(_Task);
}
}} // namespace uvxx { namespace pplx
